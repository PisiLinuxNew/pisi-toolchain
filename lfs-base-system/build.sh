...
echo "Installing PISI requirement"
echo ""
echo "Building: perl-xml-parser"
sh /scripts/perl-XML-Parser-2.46.sh > /sources/logs/perl-XML-parser-2.46 2>&1
echo "Building: setuptools"
sh /scripts/setuptools-50.3.2.sh > /sources/logs/python3-setuptools-50.3.2 2>&1
echo "Building: piksemel"
sh /scripts/piksemel.1.3.sh > /sources/logs/piksemel.1.3 2>&1
echo "Building: catbox"
sh /scripts/catbox-1.6.1.sh > /sources/logs/catbox-1.6.1 2>&1
echo "Building: pisi"
sh /scripts/pisi-3.0.0.sh > /sources/logs/pisi-3.0.0 2>&1
